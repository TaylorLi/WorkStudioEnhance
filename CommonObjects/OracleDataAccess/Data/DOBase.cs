...
namespace OracleDataAccess.Data
{
        ...
        where C : ICollection<T>, new()
    {
        ...
        {
            return OracleDataAccess.SqlUtil.ExecuteDelete(cnn, tran, ConnInfo.TableName, pc);
        }
        ...
        public int Delete(ParameterCollection pc)
        {
            ...
            {
                return OracleDataAccess.SqlUtil.ExecuteDelete(conn, ConnInfo.TableName, pc);
            }
        }
        ...
        {
            return OracleDataAccess.SqlUtil.Update(conn, tran, ConnInfo.TableName, pcValues, pcConditions);
        }
        ...
        public int Update(ParameterCollection pcValues, ParameterCollection pcConditions)
        {
            using (System.Data.IDbConnection conn = ConnInfo.Connection)
            {
                return OracleDataAccess.SqlUtil.Update(conn, ConnInfo.TableName, pcValues, pcConditions);
            }
        }
        ...
        {
            OracleDataAccess.ParameterCollection pcCondition = new ParameterCollection();
            pcCondition.Add(new Parameter(ParameterType.Initial, TokenTypes.Equal, key, keyValue));
            OracleDataAccess.ParameterCollection pcValues = new ParameterCollection();
        ...
        {
            return OracleDataAccess.SqlUtil.ExecuteInsert(conn, ConnInfo.TableName, pc);
        }

        public int Insert(IDbConnection cnn, IDbTransaction tran, ParameterCollection pc)
        {
            return OracleDataAccess.SqlUtil.ExecuteInsert(cnn, tran, ConnInfo.TableName, pc);
        }
        #endregion
