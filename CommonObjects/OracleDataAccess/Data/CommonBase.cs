        ...
        where C : ICollection<T>, new()
    {
        ...
        public int GetRecordsCount()
        {
            using (System.Data.IDbConnection conn = ConnInfo.Connection)
            {
                ...
                {
                    return Convert.ToInt32(SqlUtil.GetExecuteScalar<decimal>(conn, string.Format(SqlScriptHandler.Search.SelectRecordCountString, ConnInfo.TableName)));
                }
            }
        }
        ...
        public int GetRecordsCount(ParameterCollection pc)
        {
            using (System.Data.IDbConnection conn = ConnInfo.Connection)
            {
                ...
                {
                    return Convert.ToInt32(SqlUtil.GetRecordsCountByParsCollection<decimal>(conn, ConnInfo.TableName, pc));
                }
            }
        }
        ...
        public C GetList(string cmdText)
        {
            using (System.Data.IDbConnection conn = ConnInfo.Connection)
            {
                return OracleDataAccess.SqlUtil.GetObjectList<T, C>(conn, cmdText);
            }
        }
        ...
        public C GetList(ParameterCollection pc, params string[] orderBy)
        {
            using (System.Data.IDbConnection conn = ConnInfo.Connection)
            {
                ...
                {
                    return OracleDataAccess.SqlUtil.GetObjectList<T, C>(conn, ConnInfo.TableName, pc, 0, orderBy);
                }
            }
        }
        ...
        public C GetList(ParameterCollection pc, params object[] orderBy)
        {
            using (System.Data.IDbConnection conn = ConnInfo.Connection)
            {
                ...
                {
                    return OracleDataAccess.SqlUtil.GetObjectList<T, C>(conn, ConnInfo.TableName, pc, 0, SqlScriptHandler.ObjectsToStrings(orderBy));
                }
            }
        }
        ...
        public C GetList(ParameterCollection pc, int count, params string[] orderBy)
        {
            using (System.Data.IDbConnection conn = ConnInfo.Connection)
            {
                ...
                {
                    return OracleDataAccess.SqlUtil.GetObjectList<T, C>(conn, ConnInfo.TableName, pc, count, orderBy);
                }
            }
        }
        ...
        public C GetList(ParameterCollection pc, int count, params object[] orderBy)
        {
            using (System.Data.IDbConnection conn = ConnInfo.Connection)
            {
                ...
                {
                    return OracleDataAccess.SqlUtil.GetObjectList<T, C>(conn, ConnInfo.TableName, pc, count, SqlScriptHandler.ObjectsToStrings(orderBy));
                }
            }
        }
        ...
        public C GetList(ParameterCollection pc, bool asc, params string[] orderBy)
        {
            using (System.Data.IDbConnection conn = ConnInfo.Connection)
            {
                ...
                {
                    return OracleDataAccess.SqlUtil.GetObjectList<T, C>(conn, ConnInfo.TableName, pc, 0, asc, orderBy);
                }
            }
        }
        ...
        public C GetList(ParameterCollection pc, bool asc, params object[] orderBy)
        {
            using (System.Data.IDbConnection conn = ConnInfo.Connection)
            {
                ...
                {
                    return OracleDataAccess.SqlUtil.GetObjectList<T, C>(conn, ConnInfo.TableName, pc, 0, asc, SqlScriptHandler.ObjectsToStrings(orderBy));
                }
            }
        }
        ...
        public C GetList(ParameterCollection pc, int count, bool asc, params string[] orderBy)
        {
            using (System.Data.IDbConnection conn = ConnInfo.Connection)
            {
                ...
                {
                    return OracleDataAccess.SqlUtil.GetObjectList<T, C>(conn, ConnInfo.TableName, pc, count, asc, orderBy);
                }
            }
        }
        ...
        public C GetList(ParameterCollection pc, int count, bool asc, params object[] orderBy)
        {
            using (System.Data.IDbConnection conn = ConnInfo.Connection)
            {
                ...
                {
                    return OracleDataAccess.SqlUtil.GetObjectList<T, C>(conn, ConnInfo.TableName, pc, count, asc, SqlScriptHandler.ObjectsToStrings(orderBy));
                }
            }
        }
        ...
        public C GetList(IDbCommand cmd)
        {
            using (System.Data.IDbConnection conn = ConnInfo.Connection)
            {
                //IDbConnection cnn = OracleDataAccess.ConnectionHelper.CreateConnectionByKey(ConnInfo.ConnectionKey);
                cmd.Connection = conn;
        ...
        public IDbCommand GetIDbCommand(ParameterCollection pc, string[] columns, bool asc, params string[] orderBy)
        {
            using (System.Data.IDbConnection conn = ConnInfo.Connection)
            {
                ...
                {
                    return OracleDataAccess.SqlUtil.GetIDbCommand(conn, ConnInfo.TableName, columns, pc, 0, asc, orderBy);
                }
            }
        }
        ...
        public IDbCommand GetIDbCommand(ParameterCollection pc, int top, bool asc, params string[] orderBy)
        {
            using (System.Data.IDbConnection conn = ConnInfo.Connection)
            {
                ...
                {
                    return OracleDataAccess.SqlUtil.GetIDbCommand(conn, ConnInfo.TableName, pc, top, asc, orderBy);
                }
            }
        }
        ...
        public int GetRecordsCount(System.Data.IDbConnection conn)
        {
            ...
            {
                return Convert.ToInt32(SqlUtil.GetExecuteScalar<T>(conn, string.Format(SqlScriptHandler.Search.SelectRecordCountString, ConnInfo.TableName)));
            }
        }
