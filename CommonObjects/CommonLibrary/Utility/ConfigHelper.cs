...
namespace CommonLibrary.Utility
{
    public static class ConfigHelper
    {
        ...
        {
            return GetAppSetting(key) == "1" || GetAppSetting(key) == "Y";
        }
        ...
        public static void SetConfig<T>(T t) where T : class, new()
        {
            ...
            {
                DataMapping.ObjectHelper.SetValue<T>(t, s, GetAppSetting(s), CommonLibrary.Utility.DateHelper.DefaultDateFormat.ToString());
            }
        }
