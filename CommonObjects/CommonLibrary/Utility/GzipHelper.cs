...
{
    /// <summary>
    /// 解压或者压缩Gzip格式文件，可以解压包含单个文件的gz文件
    /// </summary>
    public class GzipHelper
    {
        ...
        /// 解压GZIP文件
        /// </summary>
        /// <param name="zipfilename">gz文件路径</param>
        /// <param name="unzipfilename">解压后的文件路径</param>
        /// <returns></returns>
        public static bool Decompress(string zipfilename, string unzipfilename)
        {
        ...
        private static void CreateZipFile(string lpSourceFile, string lpZipFile, GZipResult result)
        {
            ...
            try
            {
                ...
                gzip = new GZipOutputStream(fsOut);
