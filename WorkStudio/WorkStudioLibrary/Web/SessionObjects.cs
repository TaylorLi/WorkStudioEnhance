...
namespace WorkStudioLibrary.Web
{
    ...
    public class SessionObjects
    {
        ...
        private OracleCodeBuilderLibrary.Settings _OracleSetting;

        public OracleCodeBuilderLibrary.Settings OracleSetting
        {
            get { return _OracleSetting; }
            set { _OracleSetting = value; }
        }
