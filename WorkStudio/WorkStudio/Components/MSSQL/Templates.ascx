...
<table style="width: 100%; border: 1px solid #336699;" class="tb-header">
    ...
    <asp:Repeater ID="rptResult" runat="server">
        <ItemTemplate>
            ...
            <tr><td colspan="3" style="text-align:right;"><input type="button" onclick="AjaxMsg('Create New Template','750','560',SerUrl,'Callback/MSSQL/Template.aspx?type=2&pn=<%#Eval("ProjectName") %>&get=1','dv-content',null);"
