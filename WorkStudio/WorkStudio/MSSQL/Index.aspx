...
<asp:Content ID="Content1" ContentPlaceHolderID="MP1" runat="Server">
    ...
    <div id="content">
        ...
        <div style="text-align: right;">
            <input type="button" class="btn6" value="Create New Project" onclick="AjaxMsg('Create New Template','750','560',SerUrl,'Callback/MSSQL/Index.aspx?type=1&g=1','content',null);" /></div>
    </div>
