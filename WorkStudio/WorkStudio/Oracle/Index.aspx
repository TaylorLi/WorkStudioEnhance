<%@ Page Language="C#" MasterPageFile="~/MP.master" AutoEventWireup="true" CodeFile="Index.aspx.cs"
    Inherits="Oracle_Index" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MP1" runat="Server">
    ...
    <div id="content">
        ...
        <div style="text-align: right;">
            <input type="button" class="btn6" value="Create New Project" onclick="AjaxMsg('Create New Template','750','560',SerUrl,'Callback/Oracle/Index.aspx?type=1&g=1','content',null);" /></div>
    </div>
...
LoadTemplates();
 ...
 function LoadTemplates(){ CommonCall('Callback/Oracle/Index.aspx',0,'dv-templates','dv-templates','dv-templates','TP_','','text',null);}
  ...
  function TemplateExec(txtId,type)
 {
    ...
    {
        $.ajax({
        url:SerUrl+'Callback/Oracle/Index.aspx?type='+type+'&c='+oa(txtId),
        type:'post',
        cache:false,
        dataType:'json',
        data:'',
